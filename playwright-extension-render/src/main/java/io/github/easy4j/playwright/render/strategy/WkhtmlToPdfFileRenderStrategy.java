...
/**
 * Screenshot → single PDF file on disk.
 *
 * @author [@Loong Wan](https://github.com/loong10k)
 * @since 1.0.0
 */
public class WkhtmlToPdfFileRenderStrategy extends WkhtmlToPdfBufferRenderStrategy {

    public WkhtmlToPdfFileRenderStrategy(RenderConfig config,
