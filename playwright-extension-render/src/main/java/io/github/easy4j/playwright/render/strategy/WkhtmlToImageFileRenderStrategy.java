...
/**
 * Screenshot → file on disk. Same logic as buffer variant; differs only in
 * {@link RenderConfig#isWriteToFile()} (handled by the shared
 * {@link CaptureService}).
 *
...
public class WkhtmlToImageFileRenderStrategy extends WkhtmlToImageBufferRenderStrategy {
    ...
    public WkhtmlToImageFileRenderStrategy(RenderConfig config,
