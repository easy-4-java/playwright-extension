...
import io.github.easy4j.playwright.render.page.checker.FastImageComparator;
import io.github.easy4j.playwright.render.page.checker.ImagePixelCache;
...
public class ImageUtil {
    ...
    public static BufferedImage WHITE_A3 = ImageUtil.getWhiteImage(Float.valueOf(PDPageSize.A3.getRectangle().getWidth()).intValue(),
            Float.valueOf(PDPageSize.A3.getRectangle().getHeight()).intValue());
    public static BufferedImage WHITE_A4 = ImageUtil.getWhiteImage(Float.valueOf(PDPageSize.A4.getRectangle().getWidth()).intValue(),
            Float.valueOf(PDPageSize.A4.getRectangle().getHeight()).intValue());
    ...
    public static void main(String[] args) throws IOException {
       ...
       ImageIO.write(WHITE_A3, IMAGE_TYPE, new File("/Users/wandl/tmp/white-a3.png"));

        BufferedImage wImage =  ImageIO.read(new File("/Users/wandl/tmp/white-a3.png"));
